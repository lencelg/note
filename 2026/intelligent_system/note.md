...
### 注意力机制
引入注意力机制，神经网络能够自动地学习并选择性地关注输入中的重要信息，提高模型的性能和泛化能力。

### 模型量化与压缩
problem: 训练好的模型权重数据内存较大

MinMax 量化算法最为通用

![](./img/02ArchSlim08.png)
...
# 编译器
LLVM 提供了一套适用于编译器系统的中间语言（Intermediate Representation，IR）, 和gcc有很大的差别

![](./img/04LLVM03.png)

![](./img/04LLVM04.png)

利用类似的想法就可以在前段和后端做相应的优化，跨平台也容易
...
![](./img/04Programing02.png)

# personal view
这本书讲了方方面面，我的建议是选看对应的章节或者大概走一遍再看自己感兴趣的章节就行了
